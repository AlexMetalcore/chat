...
<body class="regadd">
	<div class="regstyle">
		<form id="formreg" onsubmit="return false">
			<label for="namereg">Ваше имя:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</label><input type="text" maxlength="20" id="namereg" class="reg" name="login" required><br><br>
			<label for="passreg">Ваш пароль:&nbsp;&nbsp;</label><input type="password" maxlength="20" id="passreg" class="reg" name="password" required><br><br>
